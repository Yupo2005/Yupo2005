...
8. To add your statistics to your GitHub Profile README, copy and paste the
   ...
   ![](https://raw.githubusercontent.com/vortene/github-stats/master/generated/overview.svg#gh-light-mode-only)
   ```
   ```md
   ![](https://raw.githubusercontent.com/vortene/github-stats/master/generated/languages.svg#gh-dark-mode-only)
   ![](https://raw.githubusercontent.com/vortene/github-stats/master/generated/languages.svg#gh-light-mode-only)
   ```
